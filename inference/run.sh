#!/bin/bash
echo "--num_inference_steps 10 --num_videos_per_prompt 1 --height 128 --width 128"
...
echo "--num_inference_steps 20 --num_videos_per_prompt 1 --height 128 --width 128"
...
echo "--num_inference_steps 30 --num_videos_per_prompt 1 --height 128 --width 128"
...
echo "--num_inference_steps 40 --num_videos_per_prompt 1 --height 128 --width 128"
...
echo "--num_inference_steps 50 --num_videos_per_prompt 1 --height 128 --width 128"
